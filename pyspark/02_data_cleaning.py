...
#   run;
#
# Note: SAS labels and formats (percent8.2) have no PySpark equivalent;
# formatting is applied at reporting time instead.
# ------------------------------------------------------------------
...
#   run;
#
# SAS array processing over a row becomes a loop over columns in PySpark.
# ------------------------------------------------------------------
numericVars = [
...
print("=" * 60)
print(f"Rows after cleaning: {dfFinal.count()}")
