...
| 2 | `sas/02_data_cleaning.sas` | `pyspark/02_data_cleaning.py` | Derived columns (LTV, LOAN_OUTCOME), missing-value flags, filtering, outlier detection |
...
│   └── 02_data_cleaning.py                    # withColumn, when/otherwise, filter, PROC MEANS
├── migration_guide/
