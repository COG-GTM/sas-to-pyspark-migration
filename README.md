...
| 3 | `sas/03_aggregation_reporting.sas` | `pyspark/03_aggregation_reporting.py` | Frequency tables, grouped summary statistics, cross-tabulations, SQL reporting |
...
│   └── 03_aggregation_reporting.py            # groupBy().count(), agg(), pivot(), spark.sql
├── migration_guide/
