...
| 5 | `sas/05_logistic_regression.sas` | `pyspark/05_logistic_regression.py` | Logistic regression default model: complete-case selection, 70/30 split, ML pipeline, confusion matrix and AUC |
...
│   └── 05_logistic_regression.py              # Pipeline, LogisticRegression, BinaryClassificationEvaluator
├── migration_guide/
